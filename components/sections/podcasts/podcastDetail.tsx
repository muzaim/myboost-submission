			...
			<div className="grid grid-cols-12 py-20 gap-[3rem]">
				...
				<div className="col-span-5 flex flex-col justify-start space-y-6 text-gray-800 leading-relaxed">
					...
					<p className="text-base">
						...
						laudantium odit delectus iure. Laudantium dolorum
						temporibus, quam architecto error recusandae? Quod
						aliquam commodi nam corporis eveniet reiciendis rem
						optio perferendis, atque dolor sit facere quam veritatis
						quia, dolorum distinctio sapiente.
					</p>
					...
					<p className="text-base">
						...
						recusandae? Quod aliquam commodi nam corporis eveniet
						reiciendis rem optio perferendis, atque dolor sit facere
						quam veritatis quia, dolorum distinctio sapiente. Lorem
						ipsum dolor sit amet consectetur adipisicing elit.
						Provident in quam libero itaque! Consequuntur,
						praesentium animi, dolores molestias doloremque et
						necessitatibus obcaecati veniam velit ut maiores, iure
						odit commodi magnam molestiae fuga consectetur tenetur
						eveniet voluptatem qui sint eum? Sit aut quos incidunt
